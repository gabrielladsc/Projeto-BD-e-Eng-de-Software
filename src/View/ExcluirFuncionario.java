...
public class ExcluirFuncionario extends javax.swing.JFrame {
    ...
    public ExcluirFuncionario() {
        ...
        for(Funcionario f: funcionario.read()){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(func.excluirFuncionario((Funcionario) jComboBox1.getSelectedItem())){
            JOptionPane.showMessageDialog(null, "Funcionario excluído com sucesso!");
            jComboBox1.removeItem((Funcionario) jComboBox1.getSelectedItem());
        }
        else{
            JOptionPane.showMessageDialog(null, "Erro ao excluir funcionario, tente novamente!");
        }
